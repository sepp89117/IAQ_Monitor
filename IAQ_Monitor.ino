...
// Buttons
Button btnStatus = Button(10, 210, 100, 30, (char *)"Status", &btnStatus_onClickHandler);
Button btnSettings = Button(120, 210, 100, 30, (char *)"Settings", &btnSettings_onClickHandler);
